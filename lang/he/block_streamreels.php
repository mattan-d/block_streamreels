...
$string['pluginname'] = 'Stream — רילס';
$string['streamreels:addinstance'] = 'הוספת בלוק רילס Stream';
$string['streamreels:myaddinstance'] = 'הוספת בלוק רילס Stream לדף הבית שלי';

$string['adminmissingstreamconfig'] = 'כתובת Stream או מפתח Stream לא הוגדרו. יש להגדיר אותם תחת ניהול האתר ← תוספים ← תוספים מקומיים ← Stream.';
